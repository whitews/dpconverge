...
ds2.plot_blobs(ds2.classifications, x_lim=[0, 4], y_lim=[0, 4])
...
#
# prelim_ds.plot_blobs(prelim_ds.classifications, x_lim=[0, 4], y_lim=[0, 4])
#
...
# best initial conditionals determined previously
initial_conditions = {
    'pis': np.array(
        [
            0.09705467,
...
component_count = len(initial_conditions['pis'])
